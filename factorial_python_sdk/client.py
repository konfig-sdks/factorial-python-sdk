...
from factorial_python_sdk.client_custom import ClientCustom
from factorial_python_sdk.configuration import Configuration
from factorial_python_sdk.api_client import ApiClient
from factorial_python_sdk.type_util import copy_signature
...
class Factorial(ClientCustom):
    ...
    def __init__(self, configuration: typing.Union[Configuration, None] = None, **kwargs):
        ...
        self.break: ModelBreakApi = ModelBreakApi(api_client)
        self.candidate: CandidateApi = CandidateApi(api_client)
        self.compensation: CompensationApi = CompensationApi(api_client)
        self.contract: ContractApi = ContractApi(api_client)
        self.contract_version: ContractVersionApi = ContractVersionApi(api_client)
        self.custom_field: CustomFieldApi = CustomFieldApi(api_client)
        self.custom_field_value: CustomFieldValueApi = CustomFieldValueApi(api_client)
        self.custom_table: CustomTableApi = CustomTableApi(api_client)
        ...
        self.family_situation: FamilySituationApi = FamilySituationApi(api_client)
        self.folder: FolderApi = FolderApi(api_client)
        self.holiday: HolidayApi = HolidayApi(api_client)
        self.integration: IntegrationApi = IntegrationApi(api_client)
        self.integration_code: IntegrationCodeApi = IntegrationCodeApi(api_client)
        self.key: KeyApi = KeyApi(api_client)
        self.leave: LeaveApi = LeaveApi(api_client)
        self.legal_entity: LegalEntityApi = LegalEntityApi(api_client)
        self.location: LocationApi = LocationApi(api_client)
        ...
        self.shift: ShiftApi = ShiftApi(api_client)
        self.supplement: SupplementApi = SupplementApi(api_client)
        self.table: TableApi = TableApi(api_client)
        self.task: TaskApi = TaskApi(api_client)
        self.taxonomy: TaxonomyApi = TaxonomyApi(api_client)
        self.team: TeamApi = TeamApi(api_client)
        self.user: UserApi = UserApi(api_client)
        self.webhook: WebhookApi = WebhookApi(api_client)
        self.workplace: WorkplaceApi = WorkplaceApi(api_client)
