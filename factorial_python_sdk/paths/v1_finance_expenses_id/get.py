...
from factorial_python_sdk.model.expense import Expense as ExpenseSchema

from factorial_python_sdk.type.expense import Expense

from ...api_client import Dictionary
from factorial_python_sdk.pydantic.expense import Expense as ExpensePydantic
...
SchemaFor200ResponseBodyApplicationJson = ExpenseSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/finance/expenses/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return ExpensePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExpensePydantic, raw_response.body)
