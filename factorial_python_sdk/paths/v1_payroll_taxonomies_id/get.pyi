...
from factorial_python_sdk.model.taxonomy import Taxonomy as TaxonomySchema

from factorial_python_sdk.type.taxonomy import Taxonomy

from ...api_client import Dictionary
from factorial_python_sdk.pydantic.taxonomy import Taxonomy as TaxonomyPydantic
...
SchemaFor200ResponseBodyApplicationJson = TaxonomySchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payroll/taxonomies/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return TaxonomyPydantic(**raw_response.body)
        return api_client.construct_model_instance(TaxonomyPydantic, raw_response.body)
