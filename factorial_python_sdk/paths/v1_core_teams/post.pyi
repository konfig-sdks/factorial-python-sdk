...
from factorial_python_sdk.model.team_create_new_team_request import TeamCreateNewTeamRequest as TeamCreateNewTeamRequestSchema

from factorial_python_sdk.type.team import Team
from factorial_python_sdk.type.team_create_new_team_request import TeamCreateNewTeamRequest

from ...api_client import Dictionary
from factorial_python_sdk.pydantic.team import Team as TeamPydantic
from factorial_python_sdk.pydantic.team_create_new_team_request import TeamCreateNewTeamRequest as TeamCreateNewTeamRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = TeamCreateNewTeamRequestSchema


request_body_team_create_new_team_request = api_client.RequestBody(
    content={
    ...
    async def _acreate_new_team_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/core/teams',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_team_create_new_team_request.serialize(body, content_type)
