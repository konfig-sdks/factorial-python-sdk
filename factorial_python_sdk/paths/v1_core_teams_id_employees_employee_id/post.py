...
class BaseApi(api_client.Api):
    ...
    def _assign_to_team_mapped_args(
        self,
        id: str,
        employee_id: str,
    ...
    async def _aassign_to_team_oapg(
        self,
...
class AssignToTeamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassign_to_team(
        self,
        id: str,
        employee_id: str,
        **kwargs,
        ...
        args = self._assign_to_team_mapped_args(
            id=id,
            employee_id=employee_id,
        )
        return await self._aassign_to_team_oapg(
    ...
    def assign_to_team(
        ...
        return self._assign_to_team_oapg(
            path_params=args.path,
        )

class AssignToTeam(BaseApi):
    ...
    async def aassign_to_team(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aassign_to_team(
            id=id,
            employee_id=employee_id,
            **kwargs,
        )
    ...
    def assign_to_team(
        ...
        raw_response = self.raw.assign_to_team(
            id=id,
            employee_id=employee_id,
        )
        if validate:
