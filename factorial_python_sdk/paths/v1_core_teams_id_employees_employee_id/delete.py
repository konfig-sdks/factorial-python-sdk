...
class BaseApi(api_client.Api):
    ...
    def _unassign_to_team_mapped_args(
        self,
        id: str,
        employee_id: str,
    ...
    async def _aunassign_to_team_oapg(
        self,
...
class UnassignToTeamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunassign_to_team(
        self,
        id: str,
        employee_id: str,
        **kwargs,
        ...
        args = self._unassign_to_team_mapped_args(
            id=id,
            employee_id=employee_id,
        )
        return await self._aunassign_to_team_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def unassign_to_team(
        self,
        id: str,
        employee_id: str,
    ) -> typing.Union[
        ...
        return self._unassign_to_team_oapg(
            path_params=args.path,
        )

class UnassignToTeam(BaseApi):
    ...
    async def aunassign_to_team(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunassign_to_team(
            id=id,
            employee_id=employee_id,
            **kwargs,
        )
    ...
    def unassign_to_team(
        ...
        raw_response = self.raw.unassign_to_team(
            id=id,
            employee_id=employee_id,
        )
        if validate:
