...
from factorial_python_sdk.model.leave_get_company_leaves200_response import LeaveGetCompanyLeaves200Response as LeaveGetCompanyLeaves200ResponseSchema

from factorial_python_sdk.type.leave_get_company_leaves200_response import LeaveGetCompanyLeaves200Response

from ...api_client import Dictionary
from factorial_python_sdk.pydantic.leave_get_company_leaves200_response import LeaveGetCompanyLeaves200Response as LeaveGetCompanyLeaves200ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LeaveGetCompanyLeaves200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveGetCompanyLeaves200Response
...
class BaseApi(api_client.Api):
    ...
    def _get_company_leaves_0_mapped_args(
        self,
    ...
    async def _aget_company_leaves_0_oapg(
        self,
    ...
    def _get_company_leaves_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCompanyLeaves0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_company_leaves_0(
        self,
        employee_ids_: typing.Optional[typing.List[int]] = None,
        leave_type_ids_: typing.Optional[typing.List[int]] = None,
        _from: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_company_leaves_0_mapped_args(
        ...
        return await self._aget_company_leaves_0_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_company_leaves_0(
        self,
        employee_ids_: typing.Optional[typing.List[int]] = None,
        leave_type_ids_: typing.Optional[typing.List[int]] = None,
        _from: typing.Optional[str] = None,
        ...
        return self._get_company_leaves_0_oapg(
            query_params=args.query,
        )

class GetCompanyLeaves0(BaseApi):
    ...
    async def aget_company_leaves_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveGetCompanyLeaves200ResponsePydantic:
        raw_response = await self.raw.aget_company_leaves_0(
            employee_ids_=employee_ids_,
            leave_type_ids_=leave_type_ids_,
            _from=_from,
            to=to,
        ...
        if validate:
            return RootModel[LeaveGetCompanyLeaves200ResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(LeaveGetCompanyLeaves200ResponsePydantic, raw_response.body)
    ...
    def get_company_leaves_0(
        ...
        raw_response = self.raw.get_company_leaves_0(
            employee_ids_=employee_ids_,
            leave_type_ids_=leave_type_ids_,
            _from=_from,
            to=to,
