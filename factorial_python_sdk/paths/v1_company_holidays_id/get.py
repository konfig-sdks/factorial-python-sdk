...
from factorial_python_sdk.model.company_holiday import CompanyHoliday as CompanyHolidaySchema

from factorial_python_sdk.type.company_holiday import CompanyHoliday

from ...api_client import Dictionary
from factorial_python_sdk.pydantic.company_holiday import CompanyHoliday as CompanyHolidayPydantic
...
SchemaFor200ResponseBodyApplicationJson = CompanyHolidaySchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/company_holidays/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompanyHolidayPydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return CompanyHolidayPydantic(**raw_response.body)
        return api_client.construct_model_instance(CompanyHolidayPydantic, raw_response.body)
