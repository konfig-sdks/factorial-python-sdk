...
class LeaveType(BaseModel):
    ...
    accrues: typing.Optional[bool] = Field(None, alias='accrues')
    ...
    attachment: typing.Optional[bool] = Field(None, alias='attachment')
    ...
    visibility: typing.Optional[bool] = Field(None, alias='visibility')
