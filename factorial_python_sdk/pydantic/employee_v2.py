...
from factorial_python_sdk.pydantic.employee_v2_team_ids import EmployeeV2TeamIds
...
class EmployeeV2(BaseModel):
    ...
    termination_observations: typing.Optional[str] = Field(None, alias='termination_observations')
    ...
    timeoff_policy_id: typing.Optional[int] = Field(None, alias='timeoff_policy_id')

    team_ids: typing.Optional[EmployeeV2TeamIds] = Field(None, alias='team_ids')
