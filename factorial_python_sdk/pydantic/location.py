...
from factorial_python_sdk.pydantic.location_company_holidays_ids import LocationCompanyHolidaysIds
...
class Location(BaseModel):
    ...
    company_holidays_ids: typing.Optional[LocationCompanyHolidaysIds] = Field(None, alias='company_holidays_ids')
