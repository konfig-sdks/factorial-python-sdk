...
class CompensationUpdateForContractRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "contracts_taxonomy_id", "compensation_type", "amount", "unit", "sync_with_supplements", "payroll_policy_id", "recurrence_count", "starts_on", "recurrence", "first_payment_on", "calculation", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "contracts_taxonomy_id", "compensation_type", "amount", "unit", "sync_with_supplements", "payroll_policy_id", "recurrence_count", "starts_on", "recurrence", "first_payment_on", "calculation", ], str]):
