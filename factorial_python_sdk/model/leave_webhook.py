...
class LeaveWebhook(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "approved", "employee_id", "start_on", "finish_on", "half_day", "leave_type_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "approved", "employee_id", "start_on", "finish_on", "half_day", "leave_type_id", ], str]):
