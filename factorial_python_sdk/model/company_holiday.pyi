...
class CompanyHoliday(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["summary", "description", "id", "date", "half_day", "location_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["summary", "description", "id", "date", "half_day", "location_id", ], str]):
