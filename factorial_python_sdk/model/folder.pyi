...
class Folder(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "company_id", "name", "active", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "company_id", "name", "active", "created_at", "updated_at", ], str]):
