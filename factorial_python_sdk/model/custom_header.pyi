...
class CustomHeader(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "label", "position", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "label", "position", ], str]):
