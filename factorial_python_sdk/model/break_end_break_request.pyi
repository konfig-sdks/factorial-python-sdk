...
class BreakEndBreakRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["now", "employee_id", "observations", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["now", "employee_id", "observations", ], str]):
