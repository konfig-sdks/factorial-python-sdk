...
class LeaveUpdateTypeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "color", "accrues", "active", "approval_required", "attachment", "visibility", "workable", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "color", "accrues", "active", "approval_required", "attachment", "visibility", "workable", ], str]):
