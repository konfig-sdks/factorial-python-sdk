...
class EmployeeCreateNewRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "first_name", "last_name", "birthday_on", "role", "gender", "identifier", "identifier_type", "nationality", "bank_number", "country", "city", "state", "postal_code", "address_line_1", "address_line_2", "swift_bic", "company_id", "manager_id", "location_id", "timeoff_manager_id", "legal_entity_id", "company_identifier", "phone_number", "social_security_number", "tax_id", ], str]):
