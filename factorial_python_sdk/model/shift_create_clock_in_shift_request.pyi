...
class ShiftCreateClockInShiftRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employee_id", "now", "observations", "location_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employee_id", "now", "observations", "location_type", ], str]):
