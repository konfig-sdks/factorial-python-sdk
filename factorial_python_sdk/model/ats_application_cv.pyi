...
class AtsApplicationCv(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["file", "content_type", "filename", "size", "created_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["file", "content_type", "filename", "size", "created_at", ], str]):
