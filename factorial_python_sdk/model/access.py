...
class Access(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "full_name", "first_name", "last_name", "employee_id", "role", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "full_name", "first_name", "last_name", "employee_id", "role", ], str]):
