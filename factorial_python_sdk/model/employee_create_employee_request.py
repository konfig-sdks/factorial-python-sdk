...
class EmployeeCreateEmployeeRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "first_name", "last_name", "birthday_on", "start_date", "regular_access_starts_on", "manager_id", "role", "timeoff_manager_id", "terminated_on", "termination_reason", "company_identifier", "phone_number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "first_name", "last_name", "birthday_on", "start_date", "regular_access_starts_on", "manager_id", "role", "timeoff_manager_id", "terminated_on", "termination_reason", "company_identifier", "phone_number", ], str]):
