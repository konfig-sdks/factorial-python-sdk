...
class CandidateCreateNewCandidateRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["first_name", "last_name", "email", "source", "medium", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["first_name", "last_name", "email", "source", "medium", ], str]):
