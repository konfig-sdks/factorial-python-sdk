...
class CustomResourceValue(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["1", "2", "id", "employee_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["1", "2", "id", "employee_id", ], str]):
