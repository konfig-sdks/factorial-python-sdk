...
class LegalEntity(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            tax_identification_number = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tax_identification_number"]) -> MetaOapg.properties.tax_identification_number: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "city", "state", "postal_code", "address_line_1", "address_line_2", "country", "company_id", "legal_name", "tax_identification_number", "currency", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tax_identification_number"]) -> typing.Union[MetaOapg.properties.tax_identification_number, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "city", "state", "postal_code", "address_line_1", "address_line_2", "country", "company_id", "legal_name", "tax_identification_number", "currency", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tax_identification_number: typing.Union[MetaOapg.properties.tax_identification_number, str, schemas.Unset] = schemas.unset,
