...
class ContractVersionCreateNewVersionRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["effective_on", "employee_id", "starts_on", "ends_on", "working_hours_frequency", "working_week_days", "working_hours", "salary_frequency", "salary_amount", "job_title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["effective_on", "employee_id", "starts_on", "ends_on", "working_hours_frequency", "working_week_days", "working_hours", "salary_frequency", "salary_amount", "job_title", ], str]):
