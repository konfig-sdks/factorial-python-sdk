...
class TableCreateFieldRequestCustomFieldChoiceOptions(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "label", "value", "is_active", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "label", "value", "is_active", ], str]):
