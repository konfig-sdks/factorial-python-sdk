...
class EmployeeTerminateEmployeeRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminated_on", "termination_reason", "termination_assigned_manager_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminated_on", "termination_reason", "termination_assigned_manager_id", ], str]):
