...
class Post(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            visits_count = schemas.IntSchema
            comments_count = schemas.IntSchema
            reactions_count = schemas.IntSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["visits_count"]) -> MetaOapg.properties.visits_count: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["comments_count"]) -> MetaOapg.properties.comments_count: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reactions_count"]) -> MetaOapg.properties.reactions_count: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "id", "type", "allow_comments_and_reactions", "location", "published_at", "starts_at", "ends_at", "created_at", "updated_at", "visits_count", "comments_count", "reactions_count", "cover_image_url", "author_id", "posts_group_id", "target_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["visits_count"]) -> typing.Union[MetaOapg.properties.visits_count, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reactions_count"]) -> typing.Union[MetaOapg.properties.reactions_count, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["posts_group_id"]) -> typing.Union[MetaOapg.properties.posts_group_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "id", "type", "allow_comments_and_reactions", "location", "published_at", "starts_at", "ends_at", "created_at", "updated_at", "visits_count", "comments_count", "reactions_count", "cover_image_url", "author_id", "posts_group_id", "target_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        visits_count: typing.Union[MetaOapg.properties.visits_count, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        comments_count: typing.Union[MetaOapg.properties.comments_count, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        reactions_count: typing.Union[MetaOapg.properties.reactions_count, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        posts_group_id: typing.Union[MetaOapg.properties.posts_group_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
