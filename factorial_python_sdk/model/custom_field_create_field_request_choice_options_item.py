...
class CustomFieldCreateFieldRequestChoiceOptionsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["label", "is_active", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["label", "is_active", ], str]):
    ...
    ) -> 'CustomFieldCreateFieldRequestChoiceOptionsItem':
