...
class Location(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def company_holidays_ids() -> typing.Type['LocationCompanyHolidaysIds']:
                return LocationCompanyHolidaysIds
            __annotations__ = {
                "id": id,
                "name": name,
                "country": country,
                ...
                "timezone": timezone,
                "company_holidays_ids": company_holidays_ids,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["company_holidays_ids"]) -> 'LocationCompanyHolidaysIds': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "country", "phone_number", "state", "city", "address_line_1", "address_line_2", "postal_code", "timezone", "company_holidays_ids", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["company_holidays_ids"]) -> typing.Union['LocationCompanyHolidaysIds', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "country", "phone_number", "state", "city", "address_line_1", "address_line_2", "postal_code", "timezone", "company_holidays_ids", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        company_holidays_ids: typing.Union['LocationCompanyHolidaysIds', schemas.Unset] = schemas.unset,
