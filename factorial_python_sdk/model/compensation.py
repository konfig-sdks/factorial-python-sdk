...
class Compensation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "id", "contract_version_id", "compensation_type", "amount", "recurrence", "first_payment_on", "sync_with_supplements", "contracts_taxonomy_id", "payroll_policy_id", "recurrence_count", "starts_on", "unit", "calculation", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["contract_version_id"]) -> typing.Union[MetaOapg.properties.contract_version_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "id", "contract_version_id", "compensation_type", "amount", "recurrence", "first_payment_on", "sync_with_supplements", "contracts_taxonomy_id", "payroll_policy_id", "recurrence_count", "starts_on", "unit", "calculation", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        contract_version_id: typing.Union[MetaOapg.properties.contract_version_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
