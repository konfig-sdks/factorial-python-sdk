...
class Workplace(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "country", "state", "city", "address_line_1", "address_line_2", "postal_code", "phone_number", "company_id", "payroll_policy_id", "main", "timezone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "country", "state", "city", "address_line_1", "address_line_2", "postal_code", "phone_number", "company_id", "payroll_policy_id", "main", "timezone", ], str]):
