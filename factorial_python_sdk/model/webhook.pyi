...
class Webhook(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type", "target_url", "company_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type", "target_url", "company_id", ], str]):
