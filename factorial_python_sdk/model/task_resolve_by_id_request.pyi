...
class TaskResolveByIdRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["done", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["done", ], str]):
