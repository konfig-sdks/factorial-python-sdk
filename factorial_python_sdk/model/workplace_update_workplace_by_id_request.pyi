...
class WorkplaceUpdateWorkplaceByIdRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "country", "state", "city", "address_line_1", "address_line_2", "postal_code", "phone_number", "payroll_policy_id", "main", "timezone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "country", "state", "city", "address_line_1", "address_line_2", "postal_code", "phone_number", "payroll_policy_id", "main", "timezone", ], str]):
