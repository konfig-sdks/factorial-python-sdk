...
class ShiftCreateNewShiftRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["start_at", "end_at", "employee_id", "notes", "location_id", "work_area_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["start_at", "end_at", "employee_id", "notes", "location_id", "work_area_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        end_at: typing.Union[MetaOapg.properties.end_at, str, ],
