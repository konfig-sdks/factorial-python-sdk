...
class Document(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "employee_id", "company_id", "folder_id", "url", "filename", "public", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "employee_id", "company_id", "folder_id", "url", "filename", "public", "created_at", "updated_at", ], str]):
