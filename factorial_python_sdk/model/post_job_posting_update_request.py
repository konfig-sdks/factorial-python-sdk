...
class PostJobPostingUpdateRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "contract_type", "remote", "status", "schedule_type", "team_id", "location_id", "salary_format", "salary_from_amount_in_cents", "salary_to_amount_in_cents", "cv_requirement", "cover_letter_requirement", "phone_requirement", "photo_requirement", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "contract_type", "remote", "status", "schedule_type", "team_id", "location_id", "salary_format", "salary_from_amount_in_cents", "salary_to_amount_in_cents", "cv_requirement", "cover_letter_requirement", "phone_requirement", "photo_requirement", ], str]):
