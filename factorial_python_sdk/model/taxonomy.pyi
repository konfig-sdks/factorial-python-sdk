...
class Taxonomy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "archived", "default", "legal_entity_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "archived", "default", "legal_entity_id", ], str]):
