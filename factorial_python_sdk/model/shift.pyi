...
class Shift(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "day", "month", "year", "clock_in", "clock_out", "employee_id", "observations", "location_type", "in_location_latitude", "in_location_longitude", "in_location_accuracy", "out_location_latitude", "out_location_longitude", "out_location_accuracy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "day", "month", "year", "clock_in", "clock_out", "employee_id", "observations", "location_type", "in_location_latitude", "in_location_longitude", "in_location_accuracy", "out_location_latitude", "out_location_longitude", "out_location_accuracy", ], str]):
