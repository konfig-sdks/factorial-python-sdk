...
class WorkplaceCreateNewWorkplaceRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "country", "timezone", "state", "city", "address_line_1", "address_line_2", "postal_code", "phone_number", "company_id", "legal_entity_id", "main", "latitude", "longitude", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "country", "timezone", "state", "city", "address_line_1", "address_line_2", "postal_code", "phone_number", "company_id", "legal_entity_id", "main", "latitude", "longitude", ], str]):
