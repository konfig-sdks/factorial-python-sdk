...
class ShiftUpdateShiftRequest(
    ...
    employee_id: schemas.AnyTypeSchema
    now: schemas.AnyTypeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["clock_in", "clock_out", "observations", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["clock_in", "clock_out", "observations", ], str]):
