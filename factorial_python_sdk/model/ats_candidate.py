...
class AtsCandidate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "first_name", "last_name", "full_name", "email", "talent_pool", "created_at", "updated_at", "source", "medium", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "first_name", "last_name", "full_name", "email", "talent_pool", "created_at", "updated_at", "source", "medium", ], str]):
