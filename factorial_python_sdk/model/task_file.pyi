...
class TaskFile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "task_id", "filename", "path", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "task_id", "filename", "path", ], str]):
