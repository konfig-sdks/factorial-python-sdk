...
class Employee(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            regular_access_starts_on = schemas.StrSchema
            ...
            @staticmethod
            def team_ids() -> typing.Type['EmployeeTeamIds']:
                return EmployeeTeamIds
        
            @staticmethod
            def company_holiday_ids() -> typing.Type['EmployeeCompanyHolidayIds']:
                return EmployeeCompanyHolidayIds
            avatar = schemas.StrSchema
            company_identifier = schemas.StrSchema
        
            @staticmethod
            def hiring() -> typing.Type['EmployeeHiring']:
            ...
            __annotations__ = {
                ...
                "regular_access_starts_on": regular_access_starts_on,
                "phone_number": phone_number,
                "social_security_number": social_security_number,
                "start_date": start_date,
                "location_id": location_id,
                "team_ids": team_ids,
                "company_holiday_ids": company_holiday_ids,
                "avatar": avatar,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["regular_access_starts_on"]) -> MetaOapg.properties.regular_access_starts_on: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["team_ids"]) -> 'EmployeeTeamIds': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["company_holiday_ids"]) -> 'EmployeeCompanyHolidayIds': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["hiring"]) -> 'EmployeeHiring': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "email", "first_name", "last_name", "full_name", "birthday_on", "role", "terminated_on", "gender", "nationality", "bank_number", "country", "city", "state", "postal_code", "address_line_1", "address_line_2", "identifier", "identifier_type", "company_id", "legal_entity_id", "manager_id", "timeoff_manager_id", "regular_access_starts_on", "phone_number", "social_security_number", "start_date", "location_id", "team_ids", "company_holiday_ids", "avatar", "company_identifier", "hiring", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["regular_access_starts_on"]) -> typing.Union[MetaOapg.properties.regular_access_starts_on, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["team_ids"]) -> typing.Union['EmployeeTeamIds', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["company_holiday_ids"]) -> typing.Union['EmployeeCompanyHolidayIds', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["hiring"]) -> typing.Union['EmployeeHiring', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        regular_access_starts_on: typing.Union[MetaOapg.properties.regular_access_starts_on, str, schemas.Unset] = schemas.unset,
        ...
        team_ids: typing.Union['EmployeeTeamIds', schemas.Unset] = schemas.unset,
        company_holiday_ids: typing.Union['EmployeeCompanyHolidayIds', schemas.Unset] = schemas.unset,
        ...
        hiring: typing.Union['EmployeeHiring', schemas.Unset] = schemas.unset,
