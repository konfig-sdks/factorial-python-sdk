...
class Event(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type", "name", "datetime", "resource_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type", "name", "datetime", "resource_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        resource_id: typing.Union[MetaOapg.properties.resource_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
