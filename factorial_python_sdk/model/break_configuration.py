...
class BreakConfiguration(
    ...
    class MetaOapg:
        ...
        class properties:
            time_settings_break_configuration_id = schemas.IntSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["time_settings_break_configuration_id", "name", "paid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["time_settings_break_configuration_id", "name", "paid", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        time_settings_break_configuration_id: typing.Union[MetaOapg.properties.time_settings_break_configuration_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
